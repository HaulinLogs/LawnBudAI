...
### New Secrets Required for Database Migrations

You must add two new secrets for automatic database migrations:

#### 1. SUPABASE_ACCESS_TOKEN

This token authenticates the Supabase CLI with your project.
...
4. **Scopes**: Select `api` and `database`
...
4. Value: (paste the token from step 5 above)
5. Click **Add secret**

#### 2. SUPABASE_DB_PASSWORD

This is your Supabase database password (used for direct DB connections).

**Where to find it:**

1. Go to your Supabase project dashboard
2. Click **Settings > Database**
3. Under "Connection pooling", you'll see the password field
4. Or, in **Settings > Database > Connection string**, look for: `postgresql://postgres:PASSWORD@...`
...
**Security Note**: This password has full database access. Make sure it's:
- A strong password (auto-generated by Supabase is fine)
- Only used in GitHub Actions, never in code
...
2. ✅ Add `SUPABASE_DB_PASSWORD` to GitHub Secrets
3. ✅ Push code to main branch
4. ✅ Watch GitHub Actions for automatic deployment
5. ✅ Verify migrations applied: Check Supabase dashboard
6. ✅ Test the live app: https://haulinlogs.github.io/LawnBudAI/
