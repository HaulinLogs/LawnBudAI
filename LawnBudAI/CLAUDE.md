...
**See [`RULES.md`](../RULES.md) in the repository root for the complete list of mandatory rules.**

These rules apply to all team members across all AI tools (Claude Code, Cursor, etc.) and must be followed consistently. The rules cover:
